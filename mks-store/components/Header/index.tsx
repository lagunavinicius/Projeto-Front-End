...
import {CartWrapper, HeaderWrapper, NameWrapper} from "./styled";
import {useDispatch, useSelector} from "react-redux";
import {setMenu, useGlobal} from "../../store/reducers/cart";
...
const Cart = () => {
    ...
    return (
    <CartWrapper onClick={handleShowCart}>
        <svg style={{width: "1.1875em", height: "1.125em"}} viewBox="0 0 19 18" fill="none" xmlns="http://www.w3.org/2000/svg">
